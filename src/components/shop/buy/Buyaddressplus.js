...
function Buyaddressplus({userInfo,userId,setShow,update}) {
    ...
    return (
        <div  className='buywrap'>
            <div className='smallT flex j'> <div>배송지 정보</div> <Button onClick={() => window.open('/addaddress', '_blank' ,"menubar=1,resizable=1,width=400 ,height=500")}>배송지추가</Button></div>
            ...
            <div className='addressbox'> 
                ...
                <Button onClick={()=>onClick(value.id)}>선택</Button>
             </div>
             )}
