...
function getItemWithExpireTime(keyName) {
  ...
  export {sortList,addNeeds,addNeedss,getcompare,getCate,addMainCate,getMainCate,dMainCate,addCates,dSubCate,pricechange,datechange,buystates,sortedObj,formatDate,findLabelByValue,maskId,findState,setItemWithExpireTime,getItemWithExpireTime }